...
{
	public class UILoadProgress : UIState
	{
		private UIText text;
		...
		internal void SetText(string text) => this.text.SetText(text, 0.75f, true);

		internal void SetProgress(float progress) => this.progress = progress;
	}
}
