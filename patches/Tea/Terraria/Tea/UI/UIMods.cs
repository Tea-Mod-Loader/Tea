...
namespace Terraria.Tea.UI
{
	public class UIMods : UIState
	{
		...
		public override void OnInitialize() {
			...
			UITextPanel<string> uITextPanel2 = new UITextPanel<string>("Back", 1f, false);
			...
			UITextPanel<string> uITextPanel3 = new UITextPanel<string>("Reload Mods", 1f, false);
